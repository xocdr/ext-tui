...
$parent1 = new Xocdr\Tui\Ext\ContainerNode(['key' => 'parent']);

$a = new Xocdr\Tui\Ext\ContainerNode(['key' => 'A']);
$b = new Xocdr\Tui\Ext\ContainerNode(['key' => 'B']);
$c = new Xocdr\Tui\Ext\ContainerNode(['key' => 'C']);
$d = new Xocdr\Tui\Ext\ContainerNode(['key' => 'D']);

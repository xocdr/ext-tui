...
/* Color methods extracted to tui_classes.c */
 ...
 * CLASS METHODS
 *
 * PHP class method implementations have been extracted to tui_classes.c:
 *   - Color enum (toRgb, toAnsi, toAnsiBg, fromName)
 *   - TuiNode interface (getKey, getId, setKey, setId)
 ...
 *
 * Method tables are declared as extern in tui_internal.h and defined in
 * tui_classes.c with extern linkage.
 * ========================================================================== */

/* Global function arginfo moved to tui_arginfo.h */
...
static PHP_MINIT_FUNCTION(tui)
{
    ...
    /* Register Xocdr\Tui\TuiException base class (extends Exception) */
    INIT_CLASS_ENTRY(ce, "Xocdr\\Tui\\TuiException", NULL);
    tui_exception_ce = zend_register_internal_class_ex(&ce, zend_ce_exception);
